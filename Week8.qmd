...
<em>Figure: Mind map for Lecture 8</em>
:::
...
::: {align="center" style="font-size: smaller; color: gray;"}
<em>Figure: Plots of Moran's I statistic and p-values</em>
:::
...
::: {align="center" style="font-size: smaller; color: gray;"}
<em>Figure: Geographic distribution of local R2 of GWR and MGWR models for COVID-19 incidence rate associated with income inequality, median household income, % of nurse practitioners, and % of black females across the continental United States.</em>
:::
